 ...
 */
metadata {
	definition (name: "Z-Wave Always On Metering Switch", namespace: "codahq", author: "Ben Rimmasch") {
	...
	tiles {
		...
		main(["power","energy","switch"])
		details(["power","energy","switch","refresh","reset"])
	}
}
