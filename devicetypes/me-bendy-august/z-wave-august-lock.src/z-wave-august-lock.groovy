 ...
 * 	Z-Wave August Lock
 *
 *  Copyright 2018 Ben Rimmasch aka codahq
 *   
 *  This code is almost entirely based on the SmartThings Z-Wave Lock device handler
 *
 *  Changes:
 *	2018-06-30: v0.1 Initial
 *
...
def zwaveEvent(DoorLockOperationReport cmd) {
	...
	// Create an event for the contact sensor
